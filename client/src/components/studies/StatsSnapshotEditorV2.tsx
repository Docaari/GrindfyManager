  ...
  return (
    ...
    >
      ...
      <input
        ...
        defaultValue={value}
        className={`w-24 rounded border bg-background px-2 py-1 text-sm ${savedClass}`}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <header
          ...
          className="sticky top-0 z-10 bg-card border-b border-border/60 p-4 pr-12 space-y-3"
        >
          <DialogTitle className="text-lg font-semibold">{layout.name}</DialogTitle>
        ...
        <div className="p-6 pt-4">
          <div className="space-y-3 mb-4">
            <div
              ...
              className="rounded border border-dashed border-border/60 p-3 text-xs text-muted-foreground"
              onPaste={handlePaste}
              tabIndex={0}
              role="textbox"
            ...
            {orderedGroupIds.map((groupId) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span>
                      {groupId} <span className="text-muted-foreground">({groupFields.length})</span>
                    </span>
                    {expanded ? (
