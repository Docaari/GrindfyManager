...
export default function SpeedCharts({ type, data, period = "all" }: AnalyticsChartsProps) {
  switch (type) {
    ...
    case 'speedVolume': {
      ...
      return (
        <ChartPanel items={panelItems(speedChartData, 'name', 'value', CHART_COLORS.speeds)} kind="number" showPercent unit="torneios">
    ...
    case 'speedProfit':
      return (
        <ChartPanel items={panelItems(data, 'speed', 'profit', CHART_COLORS.speeds)} kind="currency">
        <ResponsiveContainer width="100%" height="100%">
    ...
    case 'speedROI': {
      ...
      return (
        <ChartPanel items={panelItems(speedROIData, 'speed', 'roi', CHART_COLORS.speeds)} kind="percent">
        <ResponsiveContainer width="100%" height="100%">
    ...
    case 'speedAvgProfit': {
      ...
      return (
        <ChartPanel items={panelItems(speedAvgProfitData, 'speed', 'avgProfit', CHART_COLORS.speeds)} kind="currency">
        <ResponsiveContainer width="100%" height="100%">
