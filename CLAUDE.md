...
- Plano de IA — Fase 1 (AI-1A/1B/1C 95% done): Fase 2 = AI-2A (write tools grade/estudo + tools diagnostico + nudges B-DOWNSWING/B-VOLUME/B-GRADE) → AI-2B (carreira + Quarterly Review + mental via warm-up + email). Ver `memory/ai_agents_improvement_plan_2026-05-11.md`.
