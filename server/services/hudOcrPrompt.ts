...
Sua tarefa: extrair pares label/value de tabelas de stats em screenshots.
...
3. Para cada stat:
   ...
   - "confidence": float 0.0-1.0 representando sua certeza na leitura. 0.95+ para texto nitido,
     0.7-0.9 para texto legivel mas com leve borrao, abaixo de 0.7 para palpite.

4. IGNORE:
   - Cabecalhos de grupo (ex: "Basic", "Preflop", "Flop")
   - Textos decorativos ou de UI (botoes, abas)
   - Numeros isolados sem label
   - Numeros entre parenteses (sample size — ex: "VPIP 22.5 (1234)" → label=VPIP, value=22.5)

5. Foque em pares label/value tabulares com alinhamento claro.
