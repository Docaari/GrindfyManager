...
| [F3a Leitura por categoria](F3a-leitura-categorias.md) | Taxonomia (16 maos feitas + 8 draws), textura, filtro que pinta a matriz, mao explicada por combo, `perVillainCombo` no motor | Opus 5 — Extra | F1 | Em curso — **frente aberta**. Arquitetura fechada: [ADR-248](../../../Docs/architecture/decisions/248-range-lab-f3a-leitura-categorias.md) + 2 diagramas; os 3 pontos abertos do ADR viraram D-F3-17/18/19 (2026-08-18) |
| [F3b Aritmetica da decisao](F3b-decisao.md) | Cascata, bloqueadores, MDF / value-blefe | Opus 5 — Alto | F1 (nao depende da F3a) | Nao iniciada — depois da F3a |
